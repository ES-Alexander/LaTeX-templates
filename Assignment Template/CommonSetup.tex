...
\usepackage{enumitem} % Allows for roman numbering of lists, start=N, etc
\usepackage{xcolor} % colour package (colour!num -> colour @ num% opacity)
...
% Sets page to:
\newcommand{\setafport}{\setpagesize{\afshort}{\aflong}} % A4 portrait
\newcommand{\setatland}{\setpagesize{\atlong}{\atshort}} % A3 landscape
\newcommand{\setafland}{\setpagesize{\aflong}{\afshort}} % A4 landscape
\newcommand{\setatport}{\setpagesize{\atshort}{\atlong}} % A3 portrait
